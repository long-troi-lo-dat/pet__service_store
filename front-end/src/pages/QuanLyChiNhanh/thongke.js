...
function ThongkeChinhanh(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:8000/thongke/dichvu/${localStorage.getItem("chinhanh")}/tongtien`)
            .then(response => {
                const data = response.data;
                ...
                <div id="content">
                    ...
                    <div class="container-fluid row">
                                    ...
                                    <div style={{ display: "flex", justifyContent: "space-around" }}>
                                        ...
                                        {dataTKTT.map((item, i) => (
                                            <span style={{ lineHeight: "64px", fontSize: "13px", minWidth: "220px" }}>
                                                Doanh thu đặt lịch là {item.sumtongtien ? item.sumtongtien.toLocaleString('vi', { style: 'currency', currency: 'VND' }) : 'N/A'}
                                            </span>
                                        ))}
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Thống kê đơn hàng đã hoàn thành của từng nhân viên chi nhánh {localStorage.getItem("chinhanh") - 1}</h6>
                                </div>
                                <div class="card-body">
                                    <Chart
                        ...
                        <div class="col-xl-6">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Thống kê tổng doanh thu đặt lịch của chi nhánh {localStorage.getItem("chinhanh") - 1}</h6>
                                </div>
                                <div class="card-body">
                                    <Chart
...
export default ThongkeChinhanh