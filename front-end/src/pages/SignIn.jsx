      ...
      <section id="banner" class="py-3 mb-5" style={{ background: "#F9F3EC" }}>
        <div class="container">
          <div class="hero-content py-5 my-3">
            <h2 class="display-1 mt-3 mb-0">Đăng nhập</h2>
        ...
        <div className="container">
          <nav>
            <div class="nav nav-tabs d-flex justify-content-center border-dark-subtle mb-3">
              <Link class="nav-link mx-3 fs-3 border-bottom border-dark-subtle border-0 text-uppercase active" to="/login">Đăng nhập</Link>
              <Link class="nav-link mx-3 fs-3 border-bottom border-dark-subtle border-0 text-uppercase" to="/register">Đăng ký</Link>
            </div>
          </nav>
          <div class="tab-pane">
            <div class="col-lg-8 offset-lg-2 mt-5">
              ...
              <form id="form1" class="form-group flex-wrap ">
                <div class="form-input col-lg-12 my-4">
                  ...
                  <input type="text" name="email" placeholder="Tên của bạn" class="form-control mb-3 p-4" />
                  ...
                  <input type="password" placeholder="Nhập lại mật khẩu" class="form-control mb-3 p-4" />
                  ...
                  <div class="d-grid my-3">
                    <a href="#" class="btn btn-dark btn-lg rounded-1">Đăng nhập</a>
                  </div>
          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
              <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg"
                style={{ paddingLeft: "2.5rem", paddingRight: "2.5rem" }} onClick={handleLoginSubmit}>Đăng nhập</button>
              <p class="small fw-bold mt-2 pt-1 mb-0">Không có tài khoản? <Link to="/register"
                class="link-danger">Đăng nhập</Link></p>
            </div>
          </div>
        </div>
      </div> */}
