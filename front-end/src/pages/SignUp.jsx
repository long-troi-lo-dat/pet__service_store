      ...
      <section id="banner" className="py-3 mb-5" style={{ background: "#F9F3EC" }}>
        <div className="container">
          <div className="hero-content py-5 my-3">
            <h2 className="display-1 mt-3 mb-0">Đăng ký</h2>
            <nav className="breadcrumb">
              <div className="breadcrumb-item">Trang chủ</div>
              <span className="breadcrumb-item active">Đăng ký</span>
            </nav>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <nav>
            <div className="nav nav-tabs d-flex justify-content-center border-dark-subtle mb-3">
              <Link className="nav-link mx-3 fs-3 border-bottom border-dark-subtle border-0 text-uppercase" to="/login">Đăng nhập</Link>
              <Link className="nav-link mx-3 fs-3 border-bottom border-dark-subtle border-0 text-uppercase active" to="/register">Đăng ký</Link>
            </div>
          </nav>
          <div className="tab-pane">
            <div className="col-lg-8 offset-lg-2 mt-5">

              <p className="mb-0">Đăng ký bằng</p>
              <hr className="my-1" />
              ...
              <p className="mb-0">Hoặc đăng ký bằng email</p>
              <hr className="my-1" />

              <form className="form-group flex-wrap">
                <div className="form-input col-lg-12 my-4">

                  <input type="text" name="hoten" placeholder="Tên của bạn" className="form-control mb-3 p-4" onChange={handleChangeInput} />
                  ...
                  {/* <input type="password" placeholder="Nhập lại mật khẩu" className="form-control mb-3 p-4" onChange={handleChangeInput} /> */}
                  ...
                  <div className="d-grid my-3">
                    <button onClick={handleRegisterSubmit} className="btn btn-dark btn-lg rounded-1">Đăng ký</button>
                  </div>
